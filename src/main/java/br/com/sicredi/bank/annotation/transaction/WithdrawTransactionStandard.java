...
@Operation(summary = "Withdraw from an account", description = "Performs a withdraw from an account.")
@ApiResponses(value = {
        @ApiResponse(responseCode = "201", description = WITHDRAW_SUCCESS,
...
public @interface WithdrawTransactionStandard {
}
