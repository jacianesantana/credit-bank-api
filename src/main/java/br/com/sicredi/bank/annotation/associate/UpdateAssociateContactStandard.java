...
@Operation(summary = "Update a associate's contact", description = "Performs the contact update of a associate.")
@ApiResponses(value = {
        @ApiResponse(responseCode = "200", description = ASSOCIATE_UPDATE_CONTACT_SUCCESS,
